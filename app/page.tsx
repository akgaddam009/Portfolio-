  ...
  return (
    <div>
      ...
      <div style={{ padding: "16px 24px 48px" }}>
        ...
        >
          I help product teams <InlineChip label="reduce ambiguity" tone="teal" scale="match" /> through <InlineChip label="research, rapid validation" tone="indigo" scale="match" /> and <InlineChip label="structured UX thinking" tone="violet" scale="match" /></motion.h1>
