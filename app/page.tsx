  ...
  return (
    <div>
      ...
      <div style={{ padding: "16px 24px 48px" }}>
        ...
        >
          Helping businesses <InlineChip label="design" tone="indigo" scale="match" variant="strip" /> products by aligning user needs, business strategy, and the messy reality in between</motion.h1>
